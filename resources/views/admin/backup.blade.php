...
<div class="col-sm-7 col-auto">
	...
	<ul class="breadcrumb">
		...
		<li class="breadcrumb-item active">Respaldo de la Aplicación</li>
	</ul>
</div>
<div class="col-sm-5 col">
    <form action="{{route('backup.store')}}" method="post">
        @csrf
        @method("PUT")
        <button class="btn btn-primary float-right mt-2" type="submit">Crear Respaldo</button>
    </form>
                                ...
                                <td class="text-center">
                                    <div class="actions">
                                        ...
                                        <a class="float-left" href="{{ route('backup.download') }}?disk={{ $b['disk'] }}&path={{ urlencode($b['file_path']) }}&file_name={{ urlencode($b['file_name']) }}">
                                            <button title="Descargar respaldo" class="btn btn-primary">
